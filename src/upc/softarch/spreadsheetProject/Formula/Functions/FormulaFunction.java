...
abstract class FormulaFunction extends FormulaOperand {
    ...
    protected List<Float> list_of_values = new ArrayList<Float>();
    ...
    protected void getOperandsFromRange(){
        ...
        if(this.range.contains(";")){
            ...
            List<Integer> first_location=spreadsheet_manager.spreadsheet.alphanumericCode2CellLocation(first_reference);
            String second_reference=references.get(1);
            List<Integer> second_location=spreadsheet_manager.spreadsheet.alphanumericCode2CellLocation(second_reference);
